...
export function buildBachGoldbergVar1Score(): QuantizedGridScore {
  ...
  const notes: QuantizedNote[] = [
    ...
    createNote(9, 3, 504, 12, 'RH', 90),
    createNote(7, 3, 516, 12, 'RH', 90),
    createNote(2, 2, 528, 24, 'LH', 90),
    createNote(6, 3, 528, 12, 'RH', 90),
    ...
    createNote(11, 3, 3384, 12, 'RH', 90),
    createNote(9, 3, 3396, 12, 'RH', 90),
    createNote(4, 2, 3408, 24, 'LH', 90),
    createNote(7, 3, 3408, 12, 'RH', 90),
    createNote(11, 3, 3420, 12, 'RH', 90),
    createNote(4, 3, 3432, 24, 'LH', 90),
    createNote(2, 3, 3444, 12, 'RH', 90),
