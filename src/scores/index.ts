...
export {
  ...
  HOLD_ENDPOINT_SPECIMEN_MEASURES,
  HOLD_ENDPOINT_SPECIMEN_MEASURES_PER_SYSTEM,
  HOLD_ENDPOINT_SPECIMEN_TICKS_PER_MEASURE,
  HOLD_ENDPOINT_SPECIMEN_TOTAL_TICKS,
  HOLD_ENDPOINT_SPECIMEN_CASES,
} from './hold-endpoint-specimen';
export {
